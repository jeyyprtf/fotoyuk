...
const dict = {
  id: {
    ...
    mirror: 'Mirror',
    capture: 'Jepret!',
    shutter: 'Tekan shutter',
    readyHint: 'Atur look dulu, baru tekan shutter ya',
    timerLabel: 'Timer',
    soundOn: 'Suara on',
    soundOff: 'Suara off',
    nextShot: 'Shot berikutnya…',
    printing: 'Nge-print dulu yaa…',
    getReady: 'Siapin pose…',
    retake: 'Ulangi',
    edit: 'Edit',
    done: 'Selesai',
    download: 'Download',
    ...
    cameraSecure: 'Kamera butuh HTTPS. Buka lewat https://fotoyuk.juan.web.id (bukan http).',
    cameraDenied: 'Izin kamera ditolak di domain ini.',
    cameraDeniedHint: 'Izin kamera terpisah per domain. Allow di vercel.app ≠ allow di juan.web.id. Reset: ikon gembok di address bar → Camera → Allow → reload.',
    cameraBusy: 'Kamera lagi dipakai app lain. Tutup Zoom/Meet/kamera lain, lalu coba lagi.',
    cameraNotFound: 'Kamera tidak ketemu di device ini.',
    cameraUnsupported: 'Browser ini gak support kamera. Coba Chrome/Safari terbaru.',
...
Pertanyaan privasi: hubungi pemilik domain juan.web.id.`,
  ...
  en: {
    ...
    capture: 'Snap!',
    shutter: 'Hit shutter',
    readyHint: 'Tune your look, then hit the shutter',
    timerLabel: 'Timer',
    soundOn: 'Sound on',
    soundOff: 'Sound off',
    nextShot: 'Next shot…',
    ...
    cameraSecure: 'Camera needs HTTPS. Open https://fotoyuk.juan.web.id (not http).',
    cameraDenied: 'Camera permission denied on this domain.',
    cameraDeniedHint: 'Camera permission is per-domain. Allowing vercel.app ≠ allowing juan.web.id. Fix: lock icon in address bar → Camera → Allow → reload.',
    cameraBusy: 'Camera is in use by another app. Close Zoom/Meet/other camera apps, then retry.',
    cameraNotFound: 'No camera found on this device.',
    cameraUnsupported: 'This browser does not support camera. Try latest Chrome/Safari.',
